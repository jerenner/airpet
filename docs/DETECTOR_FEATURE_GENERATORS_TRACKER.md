...
- Current priority: support-rib and channel workflows next
...
DFG-009: add repeated support-rib and channel generators.

Focus for this task:

- prefer practical repeated-cut or repeated-placement workflows over generic sketch tools
- keep the slice detector-oriented and narrow enough to reuse the existing generator plumbing cleanly
- favor a bounded MVP that complements the new tiled sensor-array workflow rather than broadening into sketch editing
...
| DFG-009 | P2 | Generator | Add repeated support-rib and channel generators | NEXT | Prefer practical repeated-cut or repeated-placement workflows over generic sketch tools |
