...
- Current priority: audit support-rib array create/regenerate visibility and hierarchy discoverability
...
DGS-005: audit support-rib array create/regenerate visibility and revision behavior end to end.

Focus for this task:

- verify support-rib placements and generated objects stay visible after create and regenerate
- confirm scene and hierarchy discoverability are still coherent for saved rib-array outputs
- keep the audit narrow to support-rib arrays rather than broad cross-generator cleanup
...
| DGS-005 | P1 | Support Ribs | Audit support-rib array create/regenerate visibility and revision behavior end to end | NEXT | Check both placement creation and scene/hierarchy discoverability |
