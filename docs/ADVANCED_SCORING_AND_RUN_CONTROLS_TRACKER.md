...
- Current priority: expose the saved scoring setup and compact scoring results to AI/backend inspection flows
...
`ASRC-007`: add AI/backend tool surfaces for scoring inspection and result explanation.
...
| ASRC-007 | P2 | AI | Add AI/backend tool surfaces for scoring inspection and result explanation | NEXT | The AI should be able to inspect the active scoring setup and summarize the resulting run outputs |
