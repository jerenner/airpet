...
`GDML-004` Extend parameterised-solid import mappings for additional AIRPET-supported primitives found in the corpus.

Reason:
- highest-priority pending P1 after closing `GDML-003`
...
| GDML-004 | P1 | GDML | Extend parameterised-solid import mappings for additional AIRPET-supported primitives found in the corpus | NEXT | Start with the highest-frequency shapes after corpus review |
