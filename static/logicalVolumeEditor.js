...
function renderProceduralParams(type, data = null) {
    ...
    if (type === 'replica') {
        ...
        // --- Dynamically create the start transform section ---
        const hr1 = document.createElement('hr');
        const title = document.createElement('h5');
        title.textContent = 'Replica Group Transform (Optional)';
        proceduralParamsDiv.appendChild(hr1);
        proceduralParamsDiv.appendChild(title);
...
function handleConfirm() {
    ...
    if (contentType === 'replica') {
        ...
        content = {
            ...
            start_position: {
                x: document.getElementById('replica_start_pos_x').value,
                y: document.getElementById('replica_start_pos_y').value,
                z: document.getElementById('replica_start_pos_z').value,
            },
            start_rotation: {
                x: document.getElementById('replica_start_rot_x').value,
                y: document.getElementById('replica_start_rot_y').value,
                z: document.getElementById('replica_start_rot_z').value,
            }
        };
